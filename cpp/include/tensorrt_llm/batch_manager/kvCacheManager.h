...
struct WindowSizeMetadata
{
    ...
    std::string toString()
    {
        return tensorrt_llm::common::fmtstr(
            ...
            ".numPools=%d, .maxTokenNum=%d, .maxBlocksPerSeq=%d, .maxNumBlocks=%d, .temporaryAttentionWindow=%d, .numNonSinkTokensInWindow=%d }",
            allottedPrimaryBlocks, allottedSecondaryBlocks, absolutePoolsOffset, numPools, maxTokenNum, maxBlocksPerSeq,
            maxNumBlocks, temporaryAttentionWindow, numNonSinkTokensInWindow);
    }
};
...
public:
    ...
    void addSequence(GenerationRequest& sequence, SizeType32 numBlocks, bool shareLastContextBlock);
...
public:
    ...
    void addSequence(
        GenerationRequest& sequence, SizeType32 numBlocks, bool shareLastContextBlock, SizeType32 windowSize);
